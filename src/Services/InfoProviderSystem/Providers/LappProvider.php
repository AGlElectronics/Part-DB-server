...
class LappProvider implements InfoProviderInterface
{
    public const PROVIDER_KEY = 'lapp';

    public function __construct(
        private readonly LappCatalog $catalog,
        private readonly LappSettings $settings,
    ) {
    }
    ...
    public function getProviderInfo(): ProviderInfoDTO
    {
        return new ProviderInfoDTO(
            ...
            name: 'LAPP',
            description: 'Bundled LAPP ÖLFLEX cable catalog (HEAT 125 single cores).',
            url: 'https://www.lapp.com/',
            disabledHelp: 'Enable this provider in the provider settings.',
            settingsClass: LappSettings::class,
            capabilities: [
